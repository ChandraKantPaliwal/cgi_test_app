<!--BEGIN SIDEBAR MENU-->
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active">
                    	<?php echo anchor('/home', '<i class="fa fa-tachometer fa-fw"><div class="icon-bg bg-orange"></div></i><span class="menu-title">Dashboard</span>'); ?>
                    </li>
                    
                    <li>
                    	<?php echo anchor('reports', '<i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span class="menu-title">Test Module</span>'); ?>
                    </li>
